...
-- single-select dropdown (collapses to the picked value)
Combat:NewDropdown("Hit part", "Head", { "Head", "HumanoidRootPart", "UpperTorso", "Random" }, false, function() end)
...
-- multi-select dropdown (callback receives an array of picked strings)
Visuals:NewDropdown("ESP elements", nil, { "Boxes", "Names", "Health", "Tracers", "Skeleton" }, true, function() end)
